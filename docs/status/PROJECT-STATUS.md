...
- **Spatial Grounding (`spatial describe`/`spatial check` — 월드 AABB·true dimensions·표면 법선·covers/inside/on-top-of/overlaps/aligned 술어 판정, 스크린샷 없는 공간 그라운딩)**: 구현 완료 (.NET 표면 green, Plugin 핸들러 Unity-compile-pending)

...
| PR .NET xUnit test inventory | **966** | Shared/Core/Cli/Mcp local Release test output |

## Synced Public Docs

| 위치 | 현재값 | 상태 |
|------|--------|------|
| `README.md` hero / comparison / command heading / architecture | 179 commands, 966 PR .NET tests | ✅ |
| `README.ko.md` hero / comparison / command heading / architecture | 179 명령, 966 PR .NET 테스트 | ✅ |
...
| `docs/ref/architecture-mermaid.md` architecture block | 966 PR .NET xUnit tests | ✅ |
| `docs/ref/getting-started.md` architecture block | 966 PR .NET xUnit tests | ✅ |
...
| `dotnet test tests/Unityctl.Core.Tests --no-build -c Release` | ✅ 181 passed |

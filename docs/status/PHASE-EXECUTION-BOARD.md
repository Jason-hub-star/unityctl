...
| v0.6.3 IPC/Validation Hardening | listener shutdown race + bounded ping readiness probe + validation failure semantics | P0 | Done | docs/ref/competitive-analysis-2026-07-29.md | 2026-07-29 |
| Local Code Intelligence Slice | `script find-refs` deterministic local scanner, Editor/IPC 불필요 | P1 | Done | docs/ref/competitive-analysis-2026-07-29.md | 2026-07-29 |

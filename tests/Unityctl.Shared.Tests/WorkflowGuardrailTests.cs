...
public class WorkflowGuardrailTests
{
    ...
    public void PublicTrustDocs_AdvertiseCurrentPrTestInventory()
    {
        ...
        Assert.Contains("931 PR .NET tests", publicDocs[0]);
        Assert.Contains("931 PR .NET 테스트", publicDocs[1]);
        Assert.Contains("931 PR .NET xUnit tests", publicDocs[2]);
        Assert.Contains("931 PR .NET xUnit tests", publicDocs[3]);
        Assert.Contains("**931**", publicDocs[4]);
        Assert.Contains("**931개**", publicDocs[5]);

...
public class WorkflowGuardrailTests
{
    ...
    public void PublishedCliSmoke_CoversReadmeEntryPoints()
    {
        ...
        Assert.Contains("installed tool check smoke exited with unexpected code", source);
        Assert.Contains("installed tool workflow verify smoke exited with unexpected code", source);
